...
#### bbmap.sh -Xmx26G ref=./Homo_sapiens/UCSC/hg38/Sequence/WholeGenomeFasta/genome.fa in=./${2}_val_1.fq.gz  in2=./${2}_val_2.fq.gz  outm=./${2}.sam  minid=0.90  ambiguous=random  nodisk 
