...
LC_C1_1.fastq.gz
LC_C1_1.fastq.gz_trimming_report.txt
LC_C1_1_val_1_fastqc.html
LC_C1_1_val_1_fastqc.zip
LC_C1_1_val_1.fq.gz
LC_C1_2.fastq.gz
LC_C1_2.fastq.gz_trimming_report.txt
LC_C1_2_val_2_fastqc.html
LC_C1_2_val_2_fastqc.zip
LC_C1_2_val_2.fq.gz
LC_C1.bam
LC_C1_feature_counts
LC_C1_feature_counts.summary
...
count_1 <- read.table("LC_C1_nor_feature_counts", header=TRUE) 
...
count_2 <- read.table("LC_C1_feature_counts", header=TRUE) 
...
count_3 <- read.table("LC_C2_nor_feature_counts", header=TRUE) 
...
count_4 <- read.table("LC_C2_feature_counts", header=TRUE) 
...
count_5 <- read.table("LC_C3_nor_feature_counts", header=TRUE) 
...
count_6 <- read.table("LC_C3_feature_counts", header=TRUE) 
...
count_7 <- read.table("LC_C5_nor_feature_counts", header=TRUE) 
...
count_8 <- read.table("LC_C5_feature_counts", header=TRUE) 
